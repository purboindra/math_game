...
class GameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textLife = findViewById(R.id.lifeValue)
        textTime = findViewById(R.id.timeValue)

        textQuestion = findViewById(R.id.textViewQuestion)
        editTextAnswer = findViewById(R.id.textViewAnswer)
        ...
        buttonOk.setOnClickListener {
            ...
            if (input == "" || input == null) {
                ...
                if (userAnswer == correctAnswer) {
                    userScore = +10
                    textQuestion.text = "Congratulations, your answers is correct!"
